<template>
    <div>
        ...
        <div v-if="isShowAdd">
            <AddUser />
            <button class="stop" @click="stopAdd">Close</button>
        </div>
        <div v-else><button class="add" @click="addNewUser">Add new user</button></div>
        <input type="text" placeholder="Tim kiem theo ten va email" v-model="searchQuery" />
        <table>
            <thead>
                <tr>
                    <th>Name</th>
